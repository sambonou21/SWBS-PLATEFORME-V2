...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" class="swbs-form">
        @csrf
        ...
        <div class="swbs-form-group swbs-form-group-inline">
            <div>
                ...
                <input id="base_price_fcfa" name="base_price_fcfa" type="number" min="0" step="1000" value="{{ old('base_price_fcfa') }}">
